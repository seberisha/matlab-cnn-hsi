...
%%
print([fig_path 'brc961-hd-mean-spec-train'], '-depsc', '-r300')
print([fig_path 'brc961-hd-mean-spec-train'], '-dpng', '-r300')


%% average specs for test brc961
s = enviLoadHeader('brc961-hd-crop-bands-bas-nor-fin.hdr')
cd(hd_data_path)
...
%%
print([fig_path 'brc961-mean-spec-hd-test'], '-depsc', '-r300')
print([fig_path 'brc961-mean-spec-hd-test'], '-dpng', '-r300')
