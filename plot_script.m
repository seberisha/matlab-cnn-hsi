...
s = enviLoadHeader(data_path + 'br1003-br2085b-bas-nor-fin.hdr')
fs = 20;
lw = 1;
figure
...
%%
print([path 'br1003-mean-spec'], '-depsc', '-r300')
print([path 'br1003-mean-spec'], '-dpng', '-r300')
...
%%
print([path 'brc961-mean-spec'], '-depsc', '-r300')
print([path 'brc961-mean-spec'], '-dpng', '-r300')
